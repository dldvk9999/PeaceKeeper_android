    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        urlChange.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                builder.setItems(R.array.URL_List, new DialogInterface.OnClickListener(){
                    @Override
                    ...
                    TT = new TimerTask() {
                        ...
                        public void run() {
                            webView.post(new Runnable() {
                                @Override
                                public void run() {
                                    webView.evaluateJavascript("javascript:document.body.innerText", new ValueCallback<String>() {
                                        @Override
